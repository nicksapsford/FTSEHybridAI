"""
FTSEHybrid AI -- paper_trader_ftse.py  (Stanley)
...
log = logging.getLogger("FTSEHybrid.Stanley")
...
_ANALYTICS_COLS = CSV_HEADERS[14:]
...
class PaperTraderFTSE:
    ...
    def _log_trade(self, trade: FTSETrade, exit_meta: dict = None) -> None:
        ...
        try:
            ...
            for r in rows:
                ...
                try:
                    ...
                    entry = float(r["entry_price"]); direction = r["direction"]
    ...
    def _save_summary(self) -> None:
        ...
        lines = [
            "=" * 50,
            "FTSEHybrid AI -- Stanley Paper Trader Summary",
    ...
    def close_trade(self, price: float, reason: str, exit_meta: dict = None) -> Optional[FTSETrade]:
        ...
        try:
            ...
            with open(path, "a", newline="", encoding="utf-8") as f:
                ...
                w.writerow({"timestamp_utc": datetime.now(timezone.utc).isoformat(),
                    "system": "FTSEHybrid", "direction": t.direction, "entry_price": t.entry_price,
    ...
    def print_status(self) -> None:
        log.info("=" * 60)
        log.info("FTSEHybrid AI -- Stanley Paper Trader Status")
        log.info("-" * 60)
